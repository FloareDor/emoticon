        ...
        <Card className="border-gray-800 bg-gray-900/50 backdrop-blur-sm mb-8">
          <CardHeader className="text-center relative">
            ...
            <CardDescription className="text-gray-400 text-lg">
              To help with <a href="https://www.google.com/search?q=what+is+alexithymia" target="_blank" rel="noopener noreferrer" className="font-bold text-emerald-400 hover:underline">alexithymia</a>, <a href="https://www.google.com/search?q=what+is+animotophobia" target="_blank" rel="noopener noreferrer" className="font-bold text-emerald-400 hover:underline">animotophobia</a>, emotional awareness and intelligence.
            </CardDescription>
          </CardHeader>
        </Card>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-300">
                  This is a practice tool to help you recognize emotions in text messages and respond with empathy. It's especially useful for people with <a href="https://www.google.com/search?q=what+is+alexithymia" target="_blank" rel="noopener noreferrer" className="font-bold text-emerald-400 hover:underline">alexithymia</a> (difficulty identifying and expressing emotions), <a href="https://www.google.com/search?q=what+is+animotophobia" target="_blank" rel="noopener noreferrer" className="font-bold text-emerald-400 hover:underline">animotophobia</a> (fear of emotions), or those wanting to improve their emotional intelligence and awareness. It's designed as a low-stakes way to build emotional intelligence skills you can apply in real conversations.
                </p>
              </div>
